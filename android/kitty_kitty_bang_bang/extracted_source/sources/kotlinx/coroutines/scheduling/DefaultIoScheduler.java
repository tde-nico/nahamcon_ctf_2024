...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    public void execute(Runnable runnable) {
        mo1706dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo1706dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f3default.mo1706dispatch(coroutineContext, runnable);
    }
