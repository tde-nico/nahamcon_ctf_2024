...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo1660trySendJP2dKIU = sendChannel.mo1660trySendJP2dKIU(e);
        if (mo1660trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m1677unboximpl();
        }
        Unit unit = (Unit) mo1660trySendJP2dKIU;
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1675isSuccessimpl(sendChannel.mo1660trySendJP2dKIU(e))) {
            return;
        }
