...
public interface SendChannel<E> {
    ...
    Object mo1660trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1675isSuccessimpl(mo1660trySendJP2dKIU)) {
                return true;
            }
            Throwable m1669exceptionOrNullimpl = ChannelResult.m1669exceptionOrNullimpl(mo1660trySendJP2dKIU);
