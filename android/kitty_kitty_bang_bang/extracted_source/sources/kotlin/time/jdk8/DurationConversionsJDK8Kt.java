...
public final class DurationConversionsJDK8Kt {
    ...
    private static final Duration m1640toJavaDurationLRDsOJo(long j) {
        Duration ofSeconds = Duration.ofSeconds(kotlin.time.Duration.m1499getInWholeSecondsimpl(j), kotlin.time.Duration.m1501getNanosecondsComponentimpl(j));
