...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        for (UByte uByte : collection) {
            UByteArray.m233setVurrAj0(m222constructorimpl, i, uByte.m219unboximpl());
            i++;
        }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] m301constructorimpl = UIntArray.m301constructorimpl(collection.size());
        int i = 0;
        for (UInt uInt : collection) {
            UIntArray.m312setVXSXFK8(m301constructorimpl, i, uInt.m299unboximpl());
            i++;
        }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] m380constructorimpl = ULongArray.m380constructorimpl(collection.size());
        int i = 0;
        for (ULong uLong : collection) {
            ULongArray.m391setk8EXiF4(m380constructorimpl, i, uLong.m378unboximpl());
            i++;
        }
        return m380constructorimpl;
    }

    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] m485constructorimpl = UShortArray.m485constructorimpl(collection.size());
        int i = 0;
        for (UShort uShort : collection) {
            UShortArray.m496set01HTLdE(m485constructorimpl, i, uShort.m483unboximpl());
            i++;
        }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt uInt : iterable) {
            i = UInt.m247constructorimpl(i + uInt.m299unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong uLong : iterable) {
            j = ULong.m326constructorimpl(j + uLong.m378unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte uByte : iterable) {
            i = UInt.m247constructorimpl(i + UInt.m247constructorimpl(uByte.m219unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort uShort : iterable) {
            i = UInt.m247constructorimpl(i + UInt.m247constructorimpl(uShort.m483unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
