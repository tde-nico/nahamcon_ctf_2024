        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m722contentEqualskV0jMPg(((UByteArray) t).m237unboximpl(), ((UByteArray) t2).m237unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m720contentEqualsFGO6Aew(((UShortArray) t).m500unboximpl(), ((UShortArray) t2).m500unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m721contentEqualsKJPZfPQ(((UIntArray) t).m316unboximpl(), ((UIntArray) t2).m316unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m723contentEqualslec5QzE(((ULongArray) t).m395unboximpl(), ((ULongArray) t2).m395unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m728contentToString2csIQuQ(uByteArray != null ? uByteArray.m237unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m730contentToStringd6D3K8(uShortArray != null ? uShortArray.m500unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m729contentToStringXUkPCBk(uIntArray != null ? uIntArray.m316unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m731contentToStringuLth9ew(uLongArray != null ? uLongArray.m395unboximpl() : null));
            } else {
