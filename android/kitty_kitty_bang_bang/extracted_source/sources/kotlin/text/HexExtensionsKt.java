...
public final class HexExtensionsKt {
    ...
    */
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m372toStringimpl(ULong.m326constructorimpl(j))));
    }
    ...
    private static final byte[] hexToByteArray(String str, int i, int i2, HexFormat hexFormat) {
        ...
        while (i3 < i2) {
            ...
            bArr[i4] = (byte) ((decimalFromHexDigitAt(str, checkContainsAt2) << 4) | decimalFromHexDigitAt(str, checkContainsAt2 + 1));
