...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        mo50clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo50clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo50clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo50clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo50clone = transition.mo50clone();
        sceneChangeSetup(viewGroup, mo50clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo50clone);
    }
