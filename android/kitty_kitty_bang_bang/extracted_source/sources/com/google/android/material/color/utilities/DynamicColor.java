...
public final class DynamicColor {
    ...
    public double getTone(DynamicScheme dynamicScheme) {
        ...
        if (function != null) {
            ...
            if (z) {
                d4 = foregroundTone(tone, contrast);
                doubleValue2 = foregroundTone(tone, contrast2);
            }
            if ((doubleValue2 - d4) * d3 < delta) {
                double d5 = delta * d3;
                doubleValue2 = MathUtils.clampDouble(0.0d, 100.0d, d4 + d5);
                if ((doubleValue2 - d4) * d3 < delta) {
                    d4 = MathUtils.clampDouble(0.0d, 100.0d, doubleValue2 - d5);
                }
            }
